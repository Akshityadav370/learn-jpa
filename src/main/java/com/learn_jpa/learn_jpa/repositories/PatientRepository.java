...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.learn_jpa.learn_jpa.dto.CPatientInfo(p.id, p.name) " +
            "from Patient p")
    List<CPatientInfo> getAllPatientsInfoConcrete();

    @Query("select new com.learn_jpa.learn_jpa.dto.BloodGroupStats(p.bloodGroup, " +
